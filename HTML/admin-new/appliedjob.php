                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">
                            APPLIED JOBS<!-- <small>Statistics Overview</small> -->
                        </h3>
                        <!-- <ol class="breadcrumb">
                            <li class="active">
                ...
                <form name="manage_vendor" id="manage_vendor" method="post" action="" class="form-inline">
                    ...
                    <fieldset>
                        <div class="form-group add_job">
                            ...
                            <input type="text" class="form-control form-control-search appliedjob
                            " id="txt_name" name="txt_name">
                        </div>
                        <div class="form-group add_job">
                            <label for="txt_email">Email:</label>
                            <input type="text" class="form-control form-control-search appliedjob" id="txt_email" name="txt_email">
                        </div>
                        <div class="form-group add_job">
                            <label for="sel_job">Job Title:</label>
                            <select name="sel_job" class="form-control-search job-title" id="sel_job" >
                          ...
                          <?php
              						...
              						<tr>
              							...
              							<td class="text-center">
              								...
              								<img src="images/preview.png" title="Preview" alt="edit" border="0px" height="25" width="25" ></a>
              							</td>
              							<!-- <td class="text-center">
