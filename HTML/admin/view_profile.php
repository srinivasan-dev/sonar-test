 ...
 <body>
	<div class="totalcontent">
		...
		<form name="status_order" id="status_order" action="#" method="post">
			<div class="billing_head" style="width:500px;"><span class="color">User Details</span></div>
      ...
      <!-- <div class="box1">Last Name</div>
        ...
        ?>
			...
			<div class="dot">:</div>
			<div class="search1">
				<?php echo $res_prod[0]['prefered_location'];?>
			</div>
			<div class="box1">details</div>
			<div class="dot">:</div>
			<div class="search1">
				<?php echo ucfirst($res_prod[0]['tel_us_more']);?>
			</div>
